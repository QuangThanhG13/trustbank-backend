...
import org.example.accoutservice.queries.web.NotificationRestClient;
...
public class NotificationServiceImpl implements NotificationService{
    ...
    @Async
    @Override
    public void sendAccountCreationNotification(String accountId, String email, LocalDateTime dateTime) {
    ...
    @Async
    @Override
    public void sendAccountDeleteNotification(String accountId, String email, LocalDateTime dateTime) {
    ...
    public void sendAccountCreditedNotification(String email, BigDecimal amountCredited, BigDecimal balance, LocalDateTime dateTime) {
        String body = "Hello! Your bank account was credited with " + amountCredited + " on " + formatDateTime(dateTime)
                + formatDateTime(dateTime) + ". Your new balance is: " + balance + " . ";
    ...
    public void sendAccountDebitedNotification(String email, BigDecimal amountDebited, BigDecimal balance, LocalDateTime dateTime) {
        String body = "Hello! Your bank account was debited with " + amountDebited + " on " + formatDateTime(dateTime) +
